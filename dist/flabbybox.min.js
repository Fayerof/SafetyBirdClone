...
this.game.load.image("bird","assets/img/SafetyCircle25.png");
this.game.load.image("pipe","assets/img/StopPin_50.png");
this.game.load.audio("jump","assets/jump.wav");
this.game.load.audio("hit","assets/hitOver.wav")
...
// Call the 'start' function when pressing the spacebar
       ...
       //var x = game.world.width/2, y = game.world.height/2;
        ...
        //var text = this.game.add.text(x-90, y-50, "Press space to start!", style);
        //text.anchor.setTo(0.5, 0.5)
       // var text = this.game.add.text(x-90, y-200, "Make Safety Bird", style);
       //text.anchor.setTo(0.5, 0.5); 
        //var text = this.game.add.text(x-90, y-150, "Pass Through", style);
       // text.anchor.setTo(0.5, 0.5);
       ...
       // if (score > 0) {
           ...
           // var style = { font: "30px Arial", fill: "#ff0000" };
            //var score_label = this.game.add.text(x-90, y+50, "Score: " + score, style);
...
create:function(){
this.noscore=!1;
this.bird=this.game.add.sprite(0,400,"bird");
this.bird.angle=70;
this.bird.anchor.setTo(-.2,.5),a(this.bird);
this.bird.body.bounce.setTo(1,1);
    //this.bird.animations.add('flap');
    //this.bird.animations.play('flap', 12, true);
    //this.game.add.tween(this.bird).to({y:15}, 350, Phaser.Easing.Linear.NONE, true, 0, 1000, true);
    
this.downHandler=this.game.input.onDown.add(this.jump,this);
this.pipes=s.add.group(),this.pipes.createMultiple(20,"pipe");
...
var t={font:"40px Arial",fill:"#ffffff",stroke:"#000000",strokeThickness:5};
    this.labelScore=this.game.add.text(20,20,this.score,t);
var e={font:"40px Arial",fill:"#D2BE27",stroke:"#000000",strokeThickness:5};
    this.labelHighScore=this.game.add.text(320,20,this.highScore,e);
...
update:function(){
    this.checkPipes(),this.bird.inWorld? this.game.physics.collide(this.bird,this.pipes,this.collisionHappened,null,this):this.restartGame()},

collisionHappened:function(){
    this.noscore=!0,this.showFinalScore(),o(this.bird);
   // if (this.bird.alive == false)
     //       return;

       // this.bird.alive = false;
    this.pipes.forEach(r);
    this.game.input.onDown.removeAll();
    this.hit_sound.play()
},
    
checkPipes:function(){null==this.currentPipe&&(this.currentPipe=this.nextPipe),null!=this.currentPipe&&this.currentPipe.x<100&&(this.addToScore(),this.currentPipe=this.nextPipe)},

jump:function(){
    this.bird.flyingIn&&(this.bird.flyingIn.stop(),n(this.bird));
    this.bird.body.velocity.y=-350;
    this.game.add.tween(this.bird).to({height:20},25,e.Easing.Linear.None,!0).to({height:25},25,e.Easing.Linear.None,!0);
    this.bird.angling&&this.bird.angling.stop();
    this.bird.angling=this.game.add.tween(this.bird).to({angle:-10},50,e.Easing.Linear.None,!0).to({angle:50},2e3,e.Easing.Linear.None,!0);
...
addOnePipe:function(t,e){
    var i=this.pipes.getFirstDead();return i.reset(t,e),i.body.velocity.x=-200,i.outOfBoundsKill=!0,i
},

addRowOfPipes:function(){
    for(var t=Math.floor(6*Math.random())+1,e=0;8>e;e++)e!=t&&e!=t+1&&(this.nextPipe=this.addOnePipe(400,60*e+10))},
    
addToScore:function(){
    this.noscore===!1&&(this.labelScore.content=++this.score,this.score==this.highScore&&(this.labelHighScore.moveScore=this.game.add.tween(this.labelHighScore).to({x:20},300,e.Easing.Sinusoidal.In,!0)),this.score>=this.highScore&&(this.labelHighScore.content=this.highScore=this.score))},
    
showFinalScore:function(){
    var t=this.score>=this.highScore?this.labelHighScore:this.labelScore,i=t===this.labelScore?this.labelHighScore:this.labelScore;
    t.moveScore&&t.moveScore.stop();
    var s=t.style;
    s.font="80px Arial",t.setStyle(s),t.game.add.tween(t).to({x:200-(t.width+40)/2,y:245-(t.height+40)/2},150,e.Easing.Quadratic.Out,!0),i.game.add.tween(i).to({alpha:0},50,e.Easing.Linear.None,!0)}},
    
s.state.add("main",h.main);
s.state.start("main")},
    {"./..\\bower_components\\phaser\\phaser.js":1,rancol:2}]},{},[3]);